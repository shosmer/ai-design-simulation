...
class AiPrices(Source):
    name = "ai_prices"
    description = "Per-token AI prices (OpenRouter catalog), accumulated into a time series"
    cadence = "continuous (series grows one snapshot per pull)"

    def fetch(self) -> list[Path]:
        return [download(URL, self.raw_dir / "models.json")]
